...
const msg = 'Hello from Azizdev Node js!';
const phoneNumber = '99xxxxxxx'; // replace with the actual phone number, e.g., 991903704, 931903704
const sms = new SendSmsApiWithEskiz(msg, phoneNumber);
sms.send();
